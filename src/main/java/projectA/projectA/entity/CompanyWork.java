...
public class CompanyWork {
    ...
    @Column(name = "welfare_benefits", nullable = true, columnDefinition = "TEXT") // สวัสดิการ
    private String welfareBenefits;

    @Column(name = "detail_work", nullable = true, columnDefinition = "TEXT") // รายละเอียดงาน
    private String detailWork;

    @Column(name = "feature", nullable = true, columnDefinition = "TEXT") // คุณสมบัติ
    @Lob
    private String feature;

    @Column(name = "contact", nullable = false, columnDefinition = "TEXT") // ติดต่อที่
